package cn.wzy.handler;

import cn.wzy.dump.table.*;
import cn.wzy.index.DataTable;
import cn.wzy.index.IndexAware;
import cn.wzy.index.adplan.AdPlanIndex;
import cn.wzy.index.adplan.AdPlanObject;
import cn.wzy.index.adunit.AdUnitIndex;
import cn.wzy.index.adunit.AdUnitObject;
import cn.wzy.index.creative.CreativeIndex;
import cn.wzy.index.creative.CreativeObject;
import cn.wzy.index.creativeunit.CreativeUnitIndex;
import cn.wzy.index.creativeunit.CreativeUnitObject;
import cn.wzy.index.district.UnitDistrictIndex;
import cn.wzy.index.interest.UnitItIndex;
import cn.wzy.index.keyword.UnitKeywordIndex;
import cn.wzy.index.utils.CommonUtils;
import cn.wzy.mysql.constant.OpType;
